<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
            @php
                $dashboardRouteName = (Auth::check() && Auth::user()->role === 'admin') ? 'admin.dashboard' : 'dashboard';
            @endphp
            <x-route-link :name="$dashboardRouteName" label="Dashboard" icon="bx-home-circle" :activePatterns="['admin.dashboard','dashboard']" />
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('products.index') ? 'active' : '' }}">
                    <a href="{{ route('products.index') }}" class="menu-link">
                        <div data-i18n="Basic">Lihat Katalog</div>
                    </a>
                </li>
            </ul>
        </li>
